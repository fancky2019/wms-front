<template>
  <div class="page-container">
	...
	<!--表格内容栏    :showOperation="showOperation"-->
	<kt-table
    :data="tableData" 
...
export default {
   ...
   // 获取语言
	 getDisplayName (key) {
      return getDisplayName('wmstask', key)[0]
    },
   handleSearch (condition) {
    ...
    async search (condition) {  
      ...
      let ret = await this.$http.postAsync("/app/WmsTask/GetList", param).catch(error=>{})  
	...
	findPage: function (data) {
      ...
      let params = {
	    ...
	    this.$http.postAsync("/app/WmsTask/GetList",params).then((res) => {
