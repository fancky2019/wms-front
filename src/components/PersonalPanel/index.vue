<template>
  <div class="personal-panel">
    <div class="personal-desc" :style="{'background':this.$store.state.app.themeColor}">
        <div class="avatar-container">
          <!-- <img class="avatar" :src="require('@/assets/user.png')" /> -->
                  <img class="avatar" :src="require('@/assets/logo-min1.jpg')" />
        </div>  
        <div class="name-role">
    ...
    <!-- <div class="personal-relation">
        ...
        <span class="relation-item">watche</span>  
...
export default {
  ...
  props: {
    ...
    //       avatar: "@/assets/logo-min1.jpg",
    //     role: "超级管理员",
    //     registeInfo: "注册时间：2016-12-25 "
    //   }
    // }
  },
  data() {
          ...
          if(this.updatePwdDataForm.newPassword != this.updatePwdDataForm.comfirmPassword) {
            ...
            return
					...
					this.$confirm('确认提交吗？', '提示', {}).then(() => {
						...
						let params = {password:this.updatePwdDataForm.password, newPassword:this.updatePwdDataForm.newPassword,user:localStorage.getItem("user")}
